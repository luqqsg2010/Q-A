...
Page({
  ...
  formSubmit: function (e) {
    ...
    var num = param.phone.trim();
    var flag = this.checkUserName(num) && this.checkPhoneIsRegist(param.username) && this.checkPassword(param);
    var that = this;
    if (flag) {
      this.setregistData1();
      app.requestApi(app.globalData.host + app.globalData.password_getCode, {
        ...
        function (e) {
          ...
          if (status < 0) {
            ...
            app.requestApi(app.globalData.host + app.globalData.password_reset, {
              phone: that.data.phoneNum,
